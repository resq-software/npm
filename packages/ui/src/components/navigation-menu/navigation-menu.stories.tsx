...
/**
 * @fileoverview Storybook stories for the Navigation Menu component — showcases its
 * variants and composition for visual review and Chromatic regression.
 *
 * @module @resq-systems/ui/components/navigation-menu/navigation-menu.stories
 */
