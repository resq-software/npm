	...
	"focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 aria-invalid:border-destructive rounded-md border border-transparent bg-clip-padding font-mono text-[11px] font-medium leading-none uppercase tracking-[0.1em] focus-visible:ring-[3px] aria-invalid:ring-[3px] [&_svg:not([class*='size-'])]:size-4 inline-flex items-center justify-center whitespace-nowrap transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none group/button select-none",
	{
		...
		variants: {
			size: {
				...
				sm: "h-7 gap-1 px-2.5 rounded-md text-[10px] in-data-[slot=button-group]:rounded-md has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2 [&_svg:not([class*='size-'])]:size-3.5",
				xs: "h-7 gap-1 rounded-md px-2 text-[10px] in-data-[slot=button-group]:rounded-md has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3",
			},
			variant: {
				default: "bg-primary text-primary-foreground hover:bg-primary/90",
				destructive:
					"border-destructive/30 bg-destructive/10 text-destructive-text hover:bg-destructive/20 focus-visible:ring-destructive/20",
				ghost:
				...
				link: "border-transparent text-info-text underline-offset-4 hover:underline",
				outline:
					"border-primary bg-transparent text-primary-text hover:bg-primary/10 aria-expanded:bg-primary/10",
				secondary:
					"border-border bg-surface text-foreground hover:border-border-hover hover:bg-card",
				urgent: "border-info bg-background text-info-text hover:bg-info/10",
			},
		},
	},
);
