...
const locations: Record<string, Location> = {
	...
	"Shelter-A": { name: "Moscone Center Shelter", lat: 37.784, lng: -122.401, type: "shelter" },
	"Shelter-B": { name: "Marina Green Shelter", lat: 37.807, lng: -122.435, type: "shelter" },
	...
	"LZ-North": {
		name: "Crissy Field Landing Zone",
		lat: 37.8039,
		lng: -122.4644,
		type: "landing-zone",
	},
	"LZ-South": {
		name: "Candlestick Point Landing Zone",
		lat: 37.7134,
		lng: -122.383,
		type: "landing-zone",
	},
...
rescueQueue.enqueue({
	...
	location: "Shelter-A",
	urgency: "medium",
	description: "Water resupply needed",
});
rescueQueue.enqueue({
	id: "RQ-002",
	location: "SF-General",
	urgency: "critical",
	description: "Blood supply critically low",
});
rescueQueue.enqueue({
	id: "RQ-003",
	location: "Shelter-B",
	urgency: "low",
	description: "Blanket request (50 units)",
});
rescueQueue.enqueue({
	id: "RQ-004",
	location: "Shelter-C",
	urgency: "high",
	description: "Insulin delivery for 12 patients",
});
rescueQueue.enqueue({
	id: "RQ-005",
	location: "UCSF-Medical",
	urgency: "critical",
	description: "Surgical kit resupply",
});
rescueQueue.enqueue({
	id: "RQ-006",
	location: "Shelter-A",
	urgency: "high",
	description: "Infant formula shortage",
});
...
while (!rescueQueue.isEmpty) {
	...
	console.log(
		`  ${order}. [${tag}] ${req.id} — ${req.description} (${locations[req.location]!.name})`,
	);
	order++;
}
